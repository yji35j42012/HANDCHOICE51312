...
model_header.innerHTML = `<div class="container">
	<div class="header__inner">
					...
					<li class="header-menu__item">
						...
						<ul class="header-submenu header-submenu_v2 header-menu__submenu">
							...
							<li class="header-submenu__item">
								<a class="header-submenu__link" href="custom_application_development.html">
		...
		<div class="header__group">
			...
			<a class="btn btn-white header__action header__action_v2" href="contact.html">Contact
				Us</a>
...
<div class="footer__inner default2">
    ...
    <div class="footer__socials_container">
        <div class="privacy-link">
            ...
            <a class="footer__privacy" href="privacy-statement.html"> Privacy
                Policy</a>
            <a class="footer__link" href="do-not-sell-or-share-my-personal-information.html"
                            ...
                            <div class="accord-content">
                                <ul class="mb-menu__submenu mb-menu__submenu--more">
                                    <li class="mb-menu__submenu-item hide-xl">
                                        <a class="mb-menu__submenu-link"
                                            href="embedded_system.html">Main</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="firmware_development.html">Firmware</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="middleware_development.html">Middleware</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="embedded.html">Embedded Apps</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="thunderbolt-solution-development.html">Thunderbolt
                                            Solutions</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="hmi_developmen.html">Human-Machine
                                            Interfaces (HMIs)</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="connectivity_solutions.html">Connectivity
                                            Solutions</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="proximity_solutions.html">Proximity
                                            Solutions</a>
                                    </li>
	...
	<div id="contactBox" class="contactBox">
							...
							<div class="contactBox_item w100">
								...
								<select id="from_country_sel"
									...
									<option value="United States Minor Outlying Islands">UAE</option>
