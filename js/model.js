var model_header = document.querySelector("#model_header")
model_header.innerHTML = `<div class="container">
	<div class="header__inner">
		<div class="header__group">
			<span id="hs_cos_wrapper_default-logo"
			...
			<nav class="header__nav">
				<ul class="header-menu header__main-menu">
						...
						<ul class="header-submenu header-submenu_v2 header-menu__submenu">
							...
							<li class="header-submenu__item">
								...
								<ul class="header-submenu header-submenu--more">
									...
									<li class="header-submenu__item">
										<a class="header-submenu__link" href="qt_development.html">
											QT Development ‌
										</a>
									</li>
								</ul>
							...
							<li class="header-submenu__item">
								<a class="header-submenu__link" href="./digital_transformation.html">
							...
							<li class="header-submenu__item">
								<a class="header-submenu__link"
									href="business-analysis-and-it-consulting.html">
									Business Analysis
								</a>
							</li>
							...
							<li class="header-submenu__item">
								<a class="header-submenu__link" href="frontend_development.html">
									Front End
								</a>
							</li>

							<li class="header-submenu__item">
								<a class="header-submenu__link" href="backend_development.html">
									Back End
								</a>
							</li>
					...
					<li class="header-menu__item">
						<div class="header-menu__link header-menu__link--with-arrow">Industries</div>
						<ul class="header-submenu header-submenu_v2 header-menu__submenu">
							<li class="header-submenu__title h3">Industries</li>

							<li class="header-submenu__item">
								<a class="header-submenu__link"
									href="software-and-technology-industry.html">
							...
							<li class="header-submenu__item">
								<a class="header-submenu__link" href="transportation-industry.html">
									Transportation
								</a>
							</li>
							...
							<li class="header-submenu__item">
								<a class="header-submenu__link" href="construction-industry.html">
									Construction
								</a>
							</li>
					...
					<li class="header-menu__item">
						<div class="header-menu__link header-menu__link--with-arrow">About</div>
						<ul class="header-submenu header-submenu_v2 header-menu__submenu">
		...
		<div class="header__group">
			...
			<a class="btn btn-white header__action header__action_v2" href="https://www.softeq.com/contact">Contact
				Us</a>
...
model_footer_default.innerHTML = `<div class="container">
<div class="footer__inner default2">
    <div style="padding-top: 1px;">
        <div id="hs_cos_wrapper_module_17587130007975"
    ...
    <div class="footer__socials_container">
        <div class="privacy-link">
            <span class="footer__copyright">© HAND CHOICE Development Corp.</span>
            <a class="footer__privacy" href="https://www.softeq.com/privacy-statement"> Privacy
                Policy</a>
            <a class="footer__link" href="https://www.softeq.com/do-not-sell-or-share-my-personal-information"
...
var model_mb_menu = document.querySelector("#model_mb_menu");
model_mb_menu.innerHTML = `<div class="mb-menu__bar js-menu-box">
<div class="mb-menu__header">
    <div class="hide-gt-xs language-switcher js-language-switcher">
        <span class="language-switcher__label">en</span>
    </div>
    <button class="menu-toggle active mb-menu__menu-toggle js-menu-toggle" data-action="close"
...
<div class="mb-menu__content">
    <div class="mb-menu__inner js-menu-scroll">
                ...
                <div class="accord-content">
                    <ul class="mb-menu__submenu js-accords">
                        <li class="mb-menu__submenu-item">
                            <div class="mb-menu__submenu-link accord-header js-accord">Custom Software
                                Development →</div>
                            <div class="accord-content">
                                <ul class="mb-menu__submenu mb-menu__submenu--more">
                                    ...
                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="qt_development.html"> QT Development
                                            ‌</a>
                                    </li>
                            ...
                            <div class="accord-content">
                                <ul class="mb-menu__submenu mb-menu__submenu--more">
                                    <li class="mb-menu__submenu-item hide-xl">
                                        <a class="mb-menu__submenu-link"
                                            href="https://www.softeq.com/embedded_system">Main</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="https://www.softeq.com/firmware_development">Firmware</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="https://www.softeq.com/middleware_development">Middleware</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="https://www.softeq.com/embedded">Embedded Apps</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="https://www.softeq.com/thunderbolt-solution-development">Thunderbolt
                                            Solutions</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="https://www.softeq.com/hmi_development">Human-Machine
                                            Interfaces (HMIs)</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="https://www.softeq.com/connectivity_solutions">Connectivity
                                            Solutions</a>
                                    </li>

                                    <li class="mb-menu__submenu-item">
                                        <a class="mb-menu__submenu-link"
                                            href="https://www.softeq.com/proximity_solutions">Proximity
                                            Solutions</a>
                                    </li>
                        ...
                        <li class="mb-menu__submenu-item">
                            ...
                            <a class="mb-menu__submenu-link"
                                href="./digital_transformation.html">Digital
                                Transformation</a>
                        ...
                        <li class="mb-menu__submenu-item">
                            ...
                            <a class="mb-menu__submenu-link"
                                href="business-analysis-and-it-consulting.html">Business
                                Analysis</a>
                        ...
                        <li class="mb-menu__submenu-item">
                            ...
                            <a class="mb-menu__submenu-link"
                                href="frontend_development.html">Front End</a>
                        ...
                        <li class="mb-menu__submenu-item">
                            ...
                            <a class="mb-menu__submenu-link"
                                href="backend_development.html">Back End</a>
                ...
                <div class="accord-content">
                    <ul class="mb-menu__submenu js-accords">
                        ...
                        <li class="mb-menu__submenu-item">
                            ...
                            <a class="mb-menu__submenu-link"
                                href="software-and-technology-industry.html">Software and
                                Technology</a>
                        ...
                        <li class="mb-menu__submenu-item">
                            ...
                            <a class="mb-menu__submenu-link"
                                href="transportation-industry.html">Transportation</a>
                        ...
                        <li class="mb-menu__submenu-item">
                            ...
                            <a class="mb-menu__submenu-link"
                                href="construction-industry.html">Construction</a>
        ...
        <a class="btn btn-white header__action_v2 header__action_mm"
